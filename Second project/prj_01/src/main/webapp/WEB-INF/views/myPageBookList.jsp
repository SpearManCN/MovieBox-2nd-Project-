...
<table align="center" width="1200px">
	...
	<td width="220px"><button onclick="goMyPageBook();" type="button" class="btn btn-primary btn-lg" style="width:100%; height:80px; background-color:#FF5A5A;">
...
<td width="35%" align="center" style="font-size:30px;">영화명</td>
<td width="15%" align="center" style="font-size:30px;">상영관/자리</td>
<td width="30%" align="center" style="font-size:30px;">상영시간</td>


<tr style="background-color:#FFFFF6;">
<td width="20%" align="center" style="font-size:30px;">2021-05-07</td>
<td width="35%" align="center" style="font-size:30px;">너의 이름은</td>
<td width="15%" align="center" style="font-size:30px;">3관 / 14번</td>
<td width="30%" align="center" style="font-size:30px;">05-07 14시20분</td>
