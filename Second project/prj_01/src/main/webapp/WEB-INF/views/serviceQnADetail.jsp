...
<script>
	...
	function goMain(){
		document.goForm.action="/serviceQnAList.do";
		document.goForm.submit();
	}
</script>
...
<table align="center" width="800px">
	...
	<td width="220px"><button onclick="goQnAList();" type="button" class="btn btn-primary btn-lg" style="width:100%; height:80px; background-color:#FF5A5A;">
